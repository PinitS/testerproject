        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="input-group">
                <div class="input-group-prepend"><span class="input-group-text" id="btnGroupAddon">#</span></div>
                <input class="form-control" type="text" id = "hashtagname" name = "hashtagname" required placeholder="{{$hashtag->hashtagname}}" aria-label="Input group example" aria-describedby="btnGroupAddon">
              </div>
