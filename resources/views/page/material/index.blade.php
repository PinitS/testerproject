...
<div class="card card-accent-info">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <button class="btn btn-info mb-1 float-md-right float-sm-right" type="button" data-toggle="modal" data-target="#largeModal"><i class="fa fa-plus"></i> Add Material</button>
        </div>
      </div>
